...
mixin _$LoginRequest {
  ...
  int get clientOrganizationId => throw _privateConstructorUsedError;
...
abstract class $LoginRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({String email, String password, int clientOrganizationId});
}
...
class _$LoginRequestCopyWithImpl<$Res, $Val extends LoginRequest>
  ...
  $Res call({
    ...
    Object? clientOrganizationId = null,
  }) {
    return _then(_value.copyWith(
      ...
      password: null == password
          ...
          : password // ignore: cast_nullable_to_non_nullable
              as String,
      clientOrganizationId: null == clientOrganizationId
          ? _value.clientOrganizationId
          : clientOrganizationId // ignore: cast_nullable_to_non_nullable
              as int,
    ) as $Val);
  }
}
...
class _$_LoginRequest implements _LoginRequest {
  ...
  @override
  String toString() {
    return 'LoginRequest(email: $email, password: $password, clientOrganizationId: $clientOrganizationId)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.clientOrganizationId, clientOrganizationId) ||
                other.clientOrganizationId == clientOrganizationId));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode =>
      Object.hash(runtimeType, email, password, clientOrganizationId);
...
abstract class _LoginRequest implements LoginRequest {
  const factory _LoginRequest(
      ...
      final int clientOrganizationId}) = _$_LoginRequest;
